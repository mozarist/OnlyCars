...
@section('content')
    <form action="{{ route('gallery.store') }}" method="POST" enctype="multipart/form-data"
        ...
        <h2 class="text-2xl font-semibold mb-4 text-white">Post Data Ke Gallery</h2>

        <!-- Judul -->
        <label class="block mb-3">
            <span class="text-sm text-zinc-300">Judul</span>
            <input type="text" name='nama_gallery' placeholder="Masukkan judul" required
        ...
        <label class="block mb-3">
            ...
            <input type="date" name="tanggal_gallery" required
