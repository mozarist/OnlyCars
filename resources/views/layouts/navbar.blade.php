<nav
    class="fixed w-full flex flex-wrap md:gap-10 justify-between items-center justify-self-start self-start top-0 text-lg list-none px-5 md:px-25 xl:px-50 2xl:px-75 py-3 z-50 border-b border-zinc-700 backdrop-blur-md">
