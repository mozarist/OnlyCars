...
@section('content')
    <form action="{{ route('events.store') }}" method="POST" enctype="multipart/form-data"
        ...
        <h2 class="text-2xl font-semibold mb-4 text-white">Post Event Baru</h2>

        <!-- Judul -->
        <label class="block mb-3">
            <span class="text-sm text-zinc-300">Judul</span>
            <input type="text" name='nama_event' placeholder="Masukkan judul" required
        ...
        <label class="block mb-3">
            ...
            <input type="text" name="lokasi_event" placeholder="Masukkan lokasi" required
                class="mt-1 block w-full rounded-lg bg-transparent border border-zinc-700 px-3 py-2 text-white placeholder:text-zinc-500 focus:outline-none focus:ring-2 focus:ring-zinc-600" />
        </label>
        ...
        <label class="block mb-3">
            ...
            <textarea rows="4" name="deskripsi_event" placeholder="Masukkan deskripsi" required
