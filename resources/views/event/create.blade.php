...
@section('content')
    <form
        class="max-w-2xl mx-auto p-6 mt-20 rounded-2xl border border-zinc-800 bg-gradient-to-tr from-black to-zinc-900 shadow-lg">
        ...
        <div class="flex items-center justify-end gap-3">
            <button type="reset"
                class="px-4 py-2 rounded-lg border border-zinc-700 text-sm text-zinc-300 hover:bg-zinc-800">Batal</button>
            <button type="submit"
                class="px-5 py-2 rounded-lg bg-gradient-to-r from-blue-700 to-sky-500 text-white text-sm hover:brightness-110">Kirim</button>
        </div>
    </form>
