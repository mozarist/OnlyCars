        ...
        @foreach ($events as $e)
            <div
                ...
                <a href="{{ route('events.show', $e->id) }}" class="flex flex-col h-full w-full hover:scale-104 transition">
                    ...
                    <div class="flex-1 p-5 flex flex-col gap-5 max-h-1/2 bg-black border border-zinc-800 rounded-b-xl overflow-hidden">
                        ...
                        <div class="flex flex-col gap-2">
                            <p class="text-zinc-500 font-semibold line-clamp-5 lg:line-clamp-3 xl:line-clamp-4 2xl:line-clamp-7">
                                {{ $e['deskripsi_event'] }}
                            </p>
